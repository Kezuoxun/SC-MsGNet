...
from vis_utils.data_utils import CameraInfo, create_point_cloud_from_depth_image, get_workspace_mask, read_diff
from vis_utils.sscm2pointcloud import *
...
'''NOTE valid scene'''
# cfgs.scene = '%04d' % random.randint(100, 130)    
...
def data_process():  # SSD_shape completion
    ...
    # checkpoints = "/home/dsp/6DCM_Grasp/6DCM/checkpoints/SSD_v2/SSD_v2_checkpoint_0029.pt"  # Zuo lod ssd
    # checkpoints = "/home/dsp/6DCM_Grasp/6DCM/checkpoints/SSC/SSC_checkpoint_0018.pt"  # lod ssc
    ...
    # seg_pre, diff = sscm_prediction_v2(sscm_net, rgb, depth, pred_depth=False, pred_cloud=True)  # for ssc ssv
    ...
    '''NOTE Chose point cloud generation  method '''
    '''ssd  generate rear pcd by diff '''
    cloud_rear = ssd2pointcloud(cloud, seg, diff)  # for ssd
    '''ssc directly generate rear pcd'''
    # seg_pre, cloud_rear = ssc_prediction_v2(sscm_net, rgb, depth)   # for ssc Zuo
    # cloud_rear = ssc2pointcloud(seg_pre, cloud_rear)  # for ssc ssv Meng
